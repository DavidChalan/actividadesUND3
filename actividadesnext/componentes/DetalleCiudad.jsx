...
function DetalleProvincia({nombre}){
    if(nombre==="almeria"){
        ...
        return notFound();
        // esto es por si alguna provincia no existe
    }
...
// esto es para cuando se ejecute se abra automaticamente
    useEffect(() => {
    setShow (true)
}, [])

// el redirect --> es para que me regrese a mi pagina andalucia-pag54 desde de cerrar la ventana modal 
  const handleClose = () => redirect("/andalucia-pag54"); 
  const handleShow = () => setShow(true);

  return (
    <>
    {/* size=lg --> para que se ponga en un tamaño adecudo */}
